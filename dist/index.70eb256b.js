...
*/ !function(n, t) {
    ...
    var o = window, r = document, a = navigator.userAgent.match(/(iPhone|iPod|iPad|Android|playbook|silk|BlackBerry|BB10|Windows Phone|Tizen|Bada|webOS|IEMobile|Opera Mini)/) || navigator.userAgent.includes("Mac") && "ontouchend" in document, u = /(Mac|iPhone|iPod|iPad)/i.test(o.navigator.userAgent), l = "ontouchstart" in o || navigator.msMaxTouchPoints > 0 || navigator.maxTouchPoints, c = !!window.MSInputMethodContext && !!document.documentMode, f = {
        test: {},
        shared: {}
    }, s = [
        "parallax",
    ...
    o.state = dn;
    var gn = "onAfterRenderNoAnchor", mn = "onClickOrTouch", wn = "moveSlideLeft", bn = "moveSlideRight", yn = "onInitialise", Sn = "bindEvents", Tn = "onDestroy", Mn = "contentChanged", An = "onScrollOverflowScrolled", xn = "onScrollPageAndSlide", kn = "onKeyDown", jn = "onMenuClick", On = "scrollPage", Ln = "landscapeScroll", Dn = "scrollBeyondFullpage", En = "onPerformMovement", Rn = "onSlideLeave", Pn = "onLeave", Fn = "afterSectionLoads", zn = "afterSlideLoads";
    function Cn(n) {
        vn.R(mn, {
            e: n,
            target: n.target
    ...
    function je(n, t, e) {
        ...
        if (null != i) {
            var o, r, a = function(n) {
                var t = n.offsetHeight, e = n.offsetTop, i = e, o = e > dn.tn, r = i - w() + t, a = Tt().bigSectionsDestination;
            ...
            if (!(pn().I.item == i && !dn.V || Tt().scrollBar && H() === u.dtop && !m(i, "fp-auto-height"))) {
                ...
                Tt().autoScrolling && Tt().continuousVertical && void 0 !== u.isMovementUp && (!u.isMovementUp && "up" == u.yMovement || u.isMovementUp && "down" == u.yMovement) && (u = function(n) {
                    ...
                    G: f.test.wn
                }), oe(r, o, u.anchorLink), vn.R(Pn, u), function(n) {
    ...
    var He, We, Ve = {
        ...
        En: function(n) {
            if (!cn() && Tt().keyboardScrolling && [
                ...
                36,
                35
            ].indexOf(n.keyCode) > -1 && !Ve.jn) return V(n), !1;
        },
        An: function() {
            Ve.kn = dn.G;
        },
        ...
        Cn: (He = 0, function(n) {
            ...
            He = t, Y(Tt().onScrollOverflow) && Xt("onScrollOverflow", {
                position: t,
                direction: e
            }), m(n.target, at) && dn.G && Ve.isScrolled(e, n.target) && Ve.Nn() && Ve.bn(pn().I.item) && vn.R(An, {
                direction: e
            });
        })
    };
    ...
    function _e(n, t, e) {
        ...
        l.Bn = (i = l.prevSlideIndex, o = l.slideIndex, i == o ? "none" : i > o ? "left" : "right"), l.direction = l.direction ? l.direction : l.Bn, l.localIsResizing || hn({
            G: !1
        }), Tt().onSlideLeave && !l.localIsResizing && "none" !== l.Bn && Y(Tt().onSlideLeave) && !1 === Xt("onSlideLeave", l) ? hn({
            W: !1
    ...
    function Ii(n) {
        ...
        if (Ni(n)) {
            ...
            var i = Wi(n);
            Pi = i.y, Fi = i.x;
            var r = Math.abs(Ei - Pi) > o.innerHeight / 100 * Tt().touchSensitivity, a = Math.abs(Ri - Fi) > b() / 100 * Tt().touchSensitivity, u = p(et, t).length && Math.abs(Ri - Fi) > Math.abs(Ei - Pi), l = Ei > Pi ? "down" : "up";
            hn({
    ...
    function Xi(n) {
        ...
        var t = n.keyCode, e = [
            37,
            39
        ].indexOf(t) > -1, i = Tt().autoScrolling || Tt().fitToSection || e;
        9 === t ? function(n) {
            ...
            if (dn.G) {
                if (!function(n) {
                    var t = io(r), e = t.indexOf(r.activeElement), i = t[n.shiftKey ? e - 1 : e + 1], o = C(i, Zn), a = C(i, $n);
                    return !o && !a;
                }(n)) {
            ...
            !function(n) {
                var t = n.shiftKey, e = r.activeElement, i = Q(e, "video") || Q(e, "audio"), o = Ve.isScrolled("up", pn().I.item), a = Ve.isScrolled("down", pn().I.item), u = [
                    37,
                    39
                ].indexOf(n.keyCode) > -1;
                if (function(n) {
    ...
    function ao(n) {
        n ? (function() {
            ...
            var e = "onwheel" in r.createElement("div") ? "wheel" : void 0 !== r.onmousewheel ? "mousewheel" : "DOMMouseScroll", i = ci();
    ...
    function uo(n) {
        var t = (new Date).getTime(), e = m(p(".fp-completely")[0], "fp-normal-scroll"), i = function(n, t) {
            ...
            if (pn().B) {
                if (e) {
                    var o;
                    if (!(i || Si("isNewKeyframe", "beyondFullpage") && hi.Un())) return (o = zt(rn(pn().C).item.offsetTop + rn(pn().C).item.offsetHeight)).element.scrollTo(0, o.options), hn({
                        Kn: !1
                    }), V(t), !1;
                    if (hi.Un()) return e = !1, hn({
                        Kn: !0
                    }), hn({
                        N: "wheel"
                    }), mi(), V(t), !1;
    ...
    function fo(n) {
        n ? (ao(!0), function() {
            if (Ci.qn && (a || l)) {
                Tt().autoScrolling && (Kt.removeEventListener(Ci.qn, Vi, {
                    passive: !1
                }), Kt.addEventListener(Ci.qn, Vi, {
                    passive: !1
                }));
                var n = Tt().touchWrapper;
                n.removeEventListener(Ci.Gn, Bi), n.removeEventListener(Ci.qn, Ii, {
                    passive: !1
                }), n.addEventListener(Ci.Gn, Bi), n.addEventListener(Ci.qn, Ii, {
                    passive: !1
                });
            }
        }()) : (ao(!1), function() {
            if (Ci.qn && (a || l)) {
                Tt().autoScrolling && (Kt.removeEventListener(Ci.qn, Ii, {
                    passive: !1
                }), Kt.removeEventListener(Ci.qn, Vi, {
                    passive: !1
                }));
                var n = Tt().touchWrapper;
                n.removeEventListener(Ci.Gn, Bi), n.removeEventListener(Ci.qn, Ii, {
    ...
    function Uo(n, t) {
        var e;
        if (Kt = p("body")[0], qt = p("html")[0], Gt = p("html, body"), !m(qt, _n)) return e = "string" == typeof n ? p(n)[0] : n, gt.touchWrapper = e, function(n) {
    ...
    return vn.D(Tn, function() {
        ...
        var n = Tt().credits.position || "right", t = [
            "left",
            "right"
        ...
        var n = [
            "-"
        ], t = "2024-0-31".split("-"), e = new Date(t[0], t[1], t[2]), i = [
            "se",
            "licen",
            "-",
            "v3",
...
//# sourceMappingURL=index.70eb256b.js.map
